...
def is_mel(name, email):
    ...
    Checks whether the user is Mel:

        >>> is_mel('Melli Melitpolski', 'mel@ubermelon.com')
        True

        >>> is_mel('Tiya Belay', 'blah@gmail.com')
        False
...
def most_and_least_common_type(treats):
    ...
    Check if it shows both least and most for one type of food:

    if the types tie for most and least:
